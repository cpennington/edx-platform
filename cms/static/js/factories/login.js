define(
    ['jquery.cookie', 'utility', 'common/js/components/utils/view_utils', 'common/js/utils/page_factory'],
    function(cookie, utility, ViewUtils, invokePageFactory) {
        'use strict';
        ...
        invokePageFactory(LoginFactory);
    }
);
